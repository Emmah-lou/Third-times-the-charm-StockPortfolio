class Portfolio extends React.Component {
  ...
  render() {
    ...
    const portfolio_market_value = portfolio.reduce((acc, stock) => stock.shares_owned * stock.market_price + acc, 0);
    const portfolio_cost = portfolio.reduce((acc, stock) => stock.shares_owned * stock.cost_per_share + acc, 0);
    const portfolio_unrealized_gain_loss = portfolio_market_value - portfolio_cost;
    ...
    return (
      ...
      <div className="container">
        ...
        <div className="row">
                ...
                {portfolio.map((stock, index) => {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td><button onClick={() => this.removeStock(index)} className="btn btn-danger">Delete</button></td>
                    </tr>
                  )
                  }
                )}
          ...
          <div className="col-12 col-md-6">
            <h4 className="mb-3">Porfolio gain/loss: $ {portfolio_unrealized_gain_loss}</h4>
          </div>
        </div>
      </div>
